...
function sms_client_js() {
	wp_register_style( 'sms_client_css', plugins_url('/css/zenzivasms.css', __FILE__));
	wp_enqueue_style( 'sms_client_css' );	
	wp_register_style( 'captcha_css', plugins_url('/captcha/captcha.css', __FILE__));
	wp_enqueue_style( 'captcha_css' );
...
function sms_adminCsslibs(){
	wp_register_style('sms-admin-style', plugins_url('/css/zenzivasms_admin.css', __FILE__));
